...
@WebServlet("/UpdateSearchWorkServlet")
public class UpdateSearchWorkServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("FindWorkByDesServlet").forward(request,response);
    }
}
